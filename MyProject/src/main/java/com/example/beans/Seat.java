...
public class Seat {
	...
	private CurrentDataOperation operation;
	...
	public CurrentDataOperation getOperation() {
		return operation;
	}

	public void setOperation(CurrentDataOperation operation) {
		this.operation = operation;
	}

	public Seat(List<String> seatNo, List<Double> price, double total, Customer customer,
			CurrentDataOperation operation) {
		super();
		this.seatNo = seatNo;
		this.price = price;
		this.total = total;
